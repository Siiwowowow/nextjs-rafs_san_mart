  ...
  return (
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-16 mt-4">
        {/* Images Section - Client Component */}
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <div>
              <p className="text-gray-500/70">Brand</p>
              <p className="font-medium">{product.brand}</p>
            </div>
            <div>
              <p className="text-gray-500/70">Color</p>
              <p className="font-medium">{product.colorOptions}</p>
            </div>
            <div>
              <p className="text-gray-500/70">Category</p>
              <p className="font-medium">{product.category}</p>
            </div>
            <div>
              <p className="text-gray-500/70">Availability</p>
